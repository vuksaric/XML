...
public class User {
    ...
    public User(RegistrationDTO registrationDTO){
        ...
        if(registrationDTO.getGender().toLowerCase().equals(services.authservices.model.Gender.Male.toString().toLowerCase(Locale.ROOT)))
            this.gender = Gender.Male;
        else if(registrationDTO.getGender().toLowerCase().equals(services.authservices.model.Gender.Female.toString().toLowerCase(Locale.ROOT)))
